...
1. Some algorithms to numerically solve Boundary value problems: <a href = "https://github.com/vaishnavisharma6/TIFR-Internship-code">Code</a>. (These were written as part of summer internship at TIFR-CAM at the end of 3rd year of my UG).

2. Some codes useful for understanding Tensorflow from basics: <a href = "https://github.com/vaishnavisharma6/Tensorflow-Practice">Code</a>.

3. Small codes to understand bandit algorithms: <a href = "https://github.com/vaishnavisharma6/OPAL_practice">Code</a> (More to come soon).
